...
if __name__ == "__main__":
	...
	elif args.agreement_marker == "na-d-f":
		agreement_marker = agreement_markers.NominativeAccusativeMarkerFusional(add_cases = add_cases)
	elif args.agreement_marker == "na-d-f3":
		agreement_marker = agreement_markers.NominativeAccusativeMarkerFusional3Decl(add_cases = add_cases)
